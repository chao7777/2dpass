...
from tools.nuscenes.eval.detection.constants import DETECTION_NAMES
from tools.nuscenes.eval.detection.evaluate import DetectionEval
from tools.nuscenes.eval.detection.utils import category_to_detection_name, detection_name_to_rel_attributes
